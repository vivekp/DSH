...
allDbTables = {
    ...
    'zobject01': [dvoice.db.models.ZObject01, 'zobject01(s)'],
    'zobject02': [dvoice.db.models.ZObject01, 'zobject02(s)'],
    'zobject03': [dvoice.db.models.ZObject01, 'zobject03(s)'],
    'zobject04': [dvoice.db.models.ZObject01, 'zobject04(s)'],
    'zobject05': [dvoice.db.models.ZObject01, 'zobject05(s)'],
    'zobject06': [dvoice.db.models.ZObject01, 'zobject06(s)'],
    'zobject07': [dvoice.db.models.ZObject01, 'zobject07(s)'],
    'zobject08': [dvoice.db.models.ZObject01, 'zobject08(s)'],
}
...
def dump_one_table(dumpFile, dumpPath, tarPath, whatKind, dumpDefinition,
    ...
    ans = dumpedVarName + ' = [\n'
    test = write_dump_file(dumpFile,dumpPath,ans)
    errorMsg = ''
...
def dump_selected(dumpFile, dumpPath, tarPath, dumpAll=False,
    ...
    # zobject01s.
    #
    errorMsg += dsh_utils.black_break_msg('dumping ZObject01 table...')
    zObject01Def = dsh_utils.union_dict(
        dsh_dump_models.DshObjectDef,
        dsh_dump_models.ZObject01Def)
    success,errMsg = dump_one_table(dumpFile, dumpPath, tarPath,
                                    dvoice.db.models.ZObject01,
                                    zObject01Def, 'SelectedZObject01s',
                                    dumpAll=dumpAll)
    totalSuccess = totalSuccess and success
    errorMsg += errMsg
    ...
    # zobject02s.
    #
    errorMsg += dsh_utils.black_break_msg('dumping ZObject02 table...')
    zObject02Def = dsh_utils.union_dict(
        dsh_dump_models.DshObjectDef,
        dsh_dump_models.ZObject02Def)
    success,errMsg = dump_one_table(dumpFile, dumpPath, tarPath,
                                    dvoice.db.models.ZObject02,
                                    zObject02Def, 'SelectedZObject02s',
                                    dumpAll=dumpAll)
    totalSuccess = totalSuccess and success
    errorMsg += errMsg
    ...
    # zobject03s.
    #
    errorMsg += dsh_utils.black_break_msg('dumping ZObject03 table...')
    zObject03Def = dsh_utils.union_dict(
        dsh_dump_models.DshObjectDef,
        dsh_dump_models.ZObject03Def)
    success,errMsg = dump_one_table(dumpFile, dumpPath, tarPath,
                                    dvoice.db.models.ZObject03,
                                    zObject03Def, 'SelectedZObject03s',
                                    dumpAll=dumpAll)
    totalSuccess = totalSuccess and success
    errorMsg += errMsg
    ...
    # zobject04s.
    #
    errorMsg += dsh_utils.black_break_msg('dumping ZObject04 table...')
    zObject04Def = dsh_utils.union_dict(
        dsh_dump_models.DshObjectDef,
        dsh_dump_models.ZObject04Def)
    success,errMsg = dump_one_table(dumpFile, dumpPath, tarPath,
                                    dvoice.db.models.ZObject04,
                                    zObject04Def, 'SelectedZObject04s',
                                    dumpAll=dumpAll)
    totalSuccess = totalSuccess and success
    errorMsg += errMsg
    ...
    # zobject05s.
    #
    errorMsg += dsh_utils.black_break_msg('dumping ZObject05 table...')
    zObject05Def = dsh_utils.union_dict(
        dsh_dump_models.DshObjectDef,
        dsh_dump_models.ZObject05Def)
    success,errMsg = dump_one_table(dumpFile, dumpPath, tarPath,
                                    dvoice.db.models.ZObject05,
                                    zObject05Def, 'SelectedZObject05s',
                                    dumpAll=dumpAll)
    totalSuccess = totalSuccess and success
    errorMsg += errMsg
    ...
    # zobject06s.
    #
    errorMsg += dsh_utils.black_break_msg('dumping ZObject06 table...')
    zObject06Def = dsh_utils.union_dict(
        dsh_dump_models.DshObjectDef,
        dsh_dump_models.ZObject06Def)
    success,errMsg = dump_one_table(dumpFile, dumpPath, tarPath,
                                    dvoice.db.models.ZObject06,
                                    zObject06Def, 'SelectedZObject06s',
                                    dumpAll=dumpAll)
    totalSuccess = totalSuccess and success
    errorMsg += errMsg
    ...
    # zobject07s.
    #
    errorMsg += dsh_utils.black_break_msg('dumping ZObject07 table...')
    zObject07Def = dsh_utils.union_dict(
        dsh_dump_models.DshObjectDef,
        dsh_dump_models.ZObject07Def)
    success,errMsg = dump_one_table(dumpFile, dumpPath, tarPath,
                                    dvoice.db.models.ZObject07,
                                    zObject07Def, 'SelectedZObject07s',
                                    dumpAll=dumpAll)
    totalSuccess = totalSuccess and success
    errorMsg += errMsg
    ...
    # zobject08s.
    #
    errorMsg += dsh_utils.black_break_msg('dumping ZObject08 table...')
    zObject08Def = dsh_utils.union_dict(
        dsh_dump_models.DshObjectDef,
        dsh_dump_models.ZObject08Def)
    success,errMsg = dump_one_table(dumpFile, dumpPath, tarPath,
                                    dvoice.db.models.ZObject08,
                                    zObject08Def, 'SelectedZObject08s',
                                    dumpAll=dumpAll)
    totalSuccess = totalSuccess and success
    errorMsg += errMsg
