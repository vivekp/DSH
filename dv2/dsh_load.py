...
def main():
    ...
    dsh_dump.load_all(dumpfile.SelectedKeyWords,
		      ...
		      dumpfile.SelectedZObject01s,
		      dumpfile.SelectedZObject02s,
		      dumpfile.SelectedZObject03s,
		      dumpfile.SelectedZObject04s,
		      dumpfile.SelectedZObject05s,
		      dumpfile.SelectedZObject06s,
		      dumpfile.SelectedZObject07s,
		      dumpfile.SelectedZObject08s,
                      overWrite)
