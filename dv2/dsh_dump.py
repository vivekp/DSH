...
allDbTables = {
    ...
    'zobject01': [dv2.db.models.ZObject01, 'zobject01(s)'],
    'zobject02': [dv2.db.models.ZObject01, 'zobject02(s)'],
    'zobject03': [dv2.db.models.ZObject01, 'zobject03(s)'],
    'zobject04': [dv2.db.models.ZObject01, 'zobject04(s)'],
    'zobject05': [dv2.db.models.ZObject01, 'zobject05(s)'],
    'zobject06': [dv2.db.models.ZObject01, 'zobject06(s)'],
    'zobject07': [dv2.db.models.ZObject01, 'zobject07(s)'],
    'zobject08': [dv2.db.models.ZObject01, 'zobject08(s)'],
}
    ...
    for fieldName,fieldContent in dump.iteritems():
        ...
        if fieldType == 'OptionalOwnerType': # new fieldType added - 10-06-09
            ...
            i0xItem = get_foreign_key(
                dv2.db.models.Person, fieldValue)
            if not i0xItem:
                dsh_utils.give_bad_news(
                    'dsh_dump.load_pointers_for_one: ' + \
        ...
        if fieldType == 'OptionalSelfsType': # new field type added 10-06-09
            ...
            # like the KeyWord type above.
            #
            i0xItem = get_foreign_key_list(dv2.db.models.Item,
                                           fieldValue)
            if i0xItem == None:
                #
                # this shouldn't happen. in the worst case, it should've
